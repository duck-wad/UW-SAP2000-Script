...
if __name__ == "__main__":
    ...
    all_members += [
        ...
        south_west_outer_leg_members,
        south_west_leg_web_members,
        north_west_inner_leg_members,
        north_west_outer_leg_members,
        north_west_leg_web_members,
        south_east_inner_leg_members,
        south_east_outer_leg_members,
        south_east_leg_web_members,
        north_east_inner_leg_members,
        north_east_outer_leg_members,
    ...
    ret = sap_add_load_patterns(sap_model, vertical_loads, lateral_loads)
