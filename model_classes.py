...
class FrameMember:
    ...
    flag: Optional[
        str] = None  # to check shit idk. mainly to check if the member is top stringer
    id: Optional[
    ...
    for node_pair in node_pairs:
        ...
        if flag == 'west leg':
            if node_pair[0][2] < node_pair[1][2]:
                args['start_restraint'] = (True, True, True, False, False,
                                           False)
            else:
                args['end_restraint'] = (True, True, True, False, False, False)
        if flag == 'east leg':
            if node_pair[0][2] < node_pair[1][2]:
                args['start_restraint'] = (False, False, True, False, False,
                                           False)
            else:
                args['end_restraint'] = (False, False, True, False, False,
                                         False)
